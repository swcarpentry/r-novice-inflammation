...
<img src="fig/01-supp-csv-CSV_WithRowNums.png" alt="csv written without row.names argument" />
...
<img src="fig/01-supp-csv-CSV_WithoutRowNums.png" alt="csv written with row.names argument" />
...
<img src="fig/01-supp-csv-CSV_WithSpecialNA.png" alt="csv written with -9999 as NA" />
