...
<img src="figure/04-cond-unnamed-chunk-2.png" title="plot of chunk unnamed-chunk-2" alt="plot of chunk unnamed-chunk-2" style="display: block; margin: auto;" />
...
<pre class='in'><code>dat <- read.csv("data/inflammation-01.csv", header = FALSE)
...
<pre class='in'><code>analyze("data/inflammation-01.csv")</code></pre>
...
<pre class='in'><code>analyze("data/inflammation-01.csv", output = "inflammation-01.pdf")</code></pre>

<img src="figure/04-cond-unnamed-chunk-13.png" title="plot of chunk unnamed-chunk-13" alt="plot of chunk unnamed-chunk-13" style="display: block; margin: auto;" />
...
<pre class='in'><code>f <- "data/inflammation-01.csv"
sub("csv", "pdf", f)</code></pre>



<div class='out'><pre class='out'><code>[1] "data/inflammation-01.pdf"
</code></pre></div>
...
<pre class='in'><code>analyze_all("inflammation")</code></pre>

<img src="figure/04-cond-unnamed-chunk-15.png" title="plot of chunk unnamed-chunk-15" alt="plot of chunk unnamed-chunk-15" style="display: block; margin: auto;" />
