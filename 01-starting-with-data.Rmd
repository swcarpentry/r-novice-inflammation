...
> ## Challenge - Changing axis labels and plot type {.challenge}
>
> Change the title for the x axis to 'time[days]'.
>
> Change the type of the plot to the line plot (i.e., add lines between data points).
>
> Hint: you can check the parameters of the function plot() using the help documention by running help(plot) or ?plot
