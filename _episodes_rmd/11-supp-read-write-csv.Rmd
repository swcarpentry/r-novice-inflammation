...
> The convention for recording missing values often depends on the individual who collected the data.
> R recognises the reserved character string `NA` as a missing value.
...
> Perhaps, in the `car-speeds.csv` data contains mistakes and the person measuring the car speeds could not accurately between "Black or "Blue" cars.
