...
> > ## Solution
> > ~~~
> >  [1] "m" "m" "m" "f" "m" "M" "f" "m" "m" "f" "m" "f" "f" "m" "m" "m" "f" "m" "m" "F"
> > [21] "f" "m" "f" "f" "m" "M" "M" "f" "m" "f" "f" "m" "m" "m" "m" "f" "f" "m" "M" "m"
> > [41] "f" "m" "m" "m" "f" "f" "M" "M" "m" "m" "m" "f" "f" "f" "m" "f" "m" "m" "m" "f"
> > [61] "f" "f" "f" "M" "f" "m" "f" "f" "M" "m" "m" "m" "F" "m" "m" "f" "M" "M" "M" "f"
> > [81] "m" "M" "M" "m" "m" "f" "f" "f" "m" "m" "f" "m" "F" "f" "m" "m" "F" "m" "M" "M"
> > ~~~
> > {: .output}
> {: .solution}
{: .challenge}
