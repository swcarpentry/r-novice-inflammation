...
R has loaded the contents of the .csv file into a variable called `dat` which is a `data frame`. A data frame is a list of variables of the same number of rows with unique row names, given class "data.frame".
...
When we address a data frame by a single column, R will return a vector of that column class and not a data frame.
