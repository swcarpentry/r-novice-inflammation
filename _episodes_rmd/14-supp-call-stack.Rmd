...
When we call `fahrenheit_to_kelvin`, R *doesn't* create the variable `temp` right away.
...
and creates the variable `result` in the stack frame for `fahrenheit_to_kelvin`:
