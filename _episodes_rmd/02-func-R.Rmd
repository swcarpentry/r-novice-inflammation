...
Aside: the formula here is from [wikipedia](https://en.wikipedia.org/wiki/Fahrenheit#Definition_and_conversion), and defines the zero point for the Kelvin scale as −459.67°F, with a scaling factor of 5/9.
