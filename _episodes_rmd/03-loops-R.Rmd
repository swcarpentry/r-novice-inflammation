...
> > ## Solution
> > ~~~
> > #' Analyse All of My Patient Inflammation Data Files
> > #'
> > #' @param pattern A regular expression matching all relevant files names within 
> > #'   the /data/ folder
> > #'
> > #' @return All plots of the average, min, and max inflammations over time.
> > #'
> > #' @examples
