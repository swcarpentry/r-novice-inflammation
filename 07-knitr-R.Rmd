...
To get started, install the `knitr` package, and if prompted, re-start your R session.

```{r, eval=FALSE}
install.packages("knitr")
```	

Now, when you click on File -> New File, there is an option for "R Markdown...". Choose this and accept the default options in the dialog box that follows (but note that you can also create presentations this way). Save the file and click on the "Knit HTML" button at the top of the script. Compare the output to the source.
