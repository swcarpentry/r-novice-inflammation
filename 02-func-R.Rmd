...
We have passed arguments to functions in two ways: directly, as in `dim(dat)`, and by name, as in `read.csv(file = "data/sample-01.csv", header = TRUE)`.
...
```{r, results="hide"}
dat <- read.csv(FALSE, "data/sample-01.csv")
```
