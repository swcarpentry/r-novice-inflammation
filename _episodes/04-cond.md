...
We pair these logical comparison tools with what R calls a [conditional statement]({{ page.root }}/reference.html#conditional-statement), and it looks like this:
