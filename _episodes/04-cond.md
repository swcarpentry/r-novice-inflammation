...
The tool R gives us for doing this is called a [conditional statement]({{ site.root }}/reference/#conditional-statement), and looks like this:
...
<img src="{{ site.root }}/fig/python-flowchart-conditional.svg" alt="Executing a Conditional" />
